...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    if num_rolls==0:
        pt=free_bacon(opponent_score)
    else:
        pt=roll_dice(num_rolls,dice)
    return pt
    # END PROBLEM 3
...
def swine_align(player_score, opponent_score):
    ...
    if opponent_score==0:
        return False
    x,y=player_score,opponent_score
    while 1:
        z = x % y
        if z==0:
            gcd=y
...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    if 0<opponent_score-player_score<=2:
        return True
    else:
        return False
    # END PROBLEM 4b
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0,score1):
        if who==0:
            pt=score0-last_score
            if pt>=running_high and pt!=0:
                print(pt, "point(s)! The most yet for Player 0")
            return announce_highest(who,score0,pt)
        if who==1:
            pt=score1-last_score
            if pt>=running_high and pt!=0:
                print(pt, "point(s)! The most yet for Player 1")
            return announce_highest(who,score1,pt)
    return say
    # END PROBLEM 7
...
def make_averaged(original_function, trials_count=1000):
    ...
    def foo(*args):
        ...
        average_point=sum/trials_count
        print("DEBUG: average_point=",average_point)
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    max=average_dice(1,dice)
    maxn=1
    for num in range(2,11):
        average=average_dice(num,dice)
        if average>max:
            max=average
            maxn=num
    return maxn
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    current_score=free_bacon(opponent_score)+score
    if extra_turn(current_score,opponent_score):
        return 0
    else:
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    set extra_turn_strategy as a good default strategy to start with
    if you are closed to the goal and free_bacon can win.So use free_bacon
    instead of taking a risk in rolling 1 or 2 dice
    """
    # BEGIN PROBLEM 12
